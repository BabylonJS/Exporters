...
namespace Maya2Babylon.Forms
{
    ...
    {
/*TODO        void QueueSetNodes(IEnumerable<uint> nodeHandles, bool doBeginUpdate = true);
...
*/    }
    ...
    public partial class NodeTreeView : TreeView, IMaxNodeTreeView
    {
/*TODO        class VisualNodeInfo
        {
            public enum EState
            {
                Added,

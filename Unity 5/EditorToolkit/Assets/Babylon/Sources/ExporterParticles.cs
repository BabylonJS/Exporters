...
namespace Unity3D2Babylon
{
    ...
    public class ExporterParticles : EditorWindow
    {
        ...
        [MenuItem("Babylon/Particle Generator", false, 209)]
        ...
        public void OnGUI()
        {
            ...
            babylonParticles = EditorGUILayout.ObjectField("Babylon Particle Sys:", babylonParticles, typeof(ParticleSystems), true) as ParticleSystems;
            EditorGUILayout.Space();
            shurikenParticles = EditorGUILayout.ObjectField("Shuriken Particle Sys:", shurikenParticles, typeof(ParticleSystem), true) as ParticleSystem;
            EditorGUILayout.Space();

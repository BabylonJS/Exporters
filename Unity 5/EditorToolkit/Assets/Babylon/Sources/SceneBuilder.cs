...
namespace Unity3D2Babylon
{
    public partial class SceneBuilder
    {
        ...
        public void ConvertFromUnity()
        {
            ...
            GameObject[] parseObjects = Object.FindObjectsOfType(typeof(GameObject)) as GameObject[];
                    ...
                    if (collisionMesh != null)
                    {
                        ...
                        if (exportationOptions.ExportPhysics)
                        {
                            ...
                            if (physics != null && physics.isActiveAndEnabled == true)
                            {
                                ...
                                if (collisionMesh != null && physics.detachFromParent == true) {
                                    collisionMesh.parentId = null;
                                }
            ...
            try
            {
                ...
                foreach (var gameObject in gameObjects)
                {
                    ...
                    if (lodGroup != null && lodGroup.enabled) {
                        ...
                        foreach (var lod in lods) {
                            ...
                            startRange += Tools.CalculateCameraDistance(nearClipingPlane, farClipingPlane, lodDistance, levelOfDetail);
                        }
                        ...
                        if (gameObject.GetComponent<Terrain>() != null) {
                            ...
                            lodGroupInfo.Add("autoGenerateLevels", (levelOfDetail != null) ? levelOfDetail.autoGenerateLevels : false);
                ...
                SceneBuilder.Metadata.properties["graphicUserInterface"] = (SceneController != null) ? SceneController.sceneOptions.graphicUserInterface : false;
        ...
        public object GetParticleSystemShader(UnityEditor.ParticleSystems particle)
        {

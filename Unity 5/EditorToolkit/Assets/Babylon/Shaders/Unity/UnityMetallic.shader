Shader "BabylonJS/System/Metallic Setup"
{
	Properties
	{
		[Enum(Opaque,0.0,Cutout,1.0,Fade,2.0,Transparent,3.0)] _Mode ("Render", Float) = 0.0
		...
		_MetallicGlossMap("Metallic Textute", 2D) = "white" {}
		...
		// Environment And reflection properties
		[ToggleOff] _SpecularHighlights("Specular Highlights", Float) = 1.0
		[ToggleOff] _GlossyReflections("Glossy Reflections", Float) = 1.0
		_ReflectionScale("Reflection Scale", Range(0.0, 10.0)) = 1.0

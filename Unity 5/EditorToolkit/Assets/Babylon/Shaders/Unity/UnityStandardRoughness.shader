...
Shader "Standard (Roughness setup)"
{
    Properties
    {
		...
		_CameraContrast("Camera Contrast", Range(0.0, 10.0)) = 1.0
		_CameraExposure("Camera Exposure", Range(0.0, 10.0)) = 1.0
		_DirectIntensity("Direct Intensity", Range(0.0, 10.0)) = 1.0
		_EmissiveIntensity("Emissive Intensity", Range(0.0, 10.0)) = 0.5
		_SpecularIntensity("Specular Intensity", Range(0.0, 10.0)) = 0.5
		_EnvironmentIntensity("Environment Intensity", Range(0.0, 10.0)) = 1.0
		_MicroSurfaceScaling("Micro Surface Scaling", Range(0.0, 1.0)) = 1.0
        _ReflectionColor("Reflection Color", Color) = (1,1,1,1)
		[ToggleOff] _BackFaceCulling("Back Face Culling", Int) = 1
		[ToggleOff] _TwoSidedLighting("Two Sided Lighting", Int) = 0
		[ToggleOff] _UseSkyboxRefraction("Set Skybox Refraction", Int) = 0
		_IndexOfRefraction("Index Of Refraction", Float) = 0.66
		[ToggleOff] _LinkRefractionWithTransparency("Link Refraction Trans", Int) = 0
		[ToggleOff] _DisableLighting("Disable Surface Lighting", Int) = 0
		_MaxSimultaneousLights("Max Simultaneous Lights", Int) = 4
		[ToggleOff] _UseSpecularOverAlpha("Use Specular Over Alpha", Int) = 0
		[ToggleOff] _UseRadianceOverAlpha("Use Radiance Over Alpha", Int) = 0
		[ToggleOff] _UsePhysicalLightFalloff("Use Physical Light Falloff", Int) = 0
		[ToggleOff] _UseEmissiveAsIllumination("Use Emissive Illumination", Int) = 0

        // No highlights
        [HideInInspector]_SpecularHighlights("Specular Highlights", Float) = 0.0
    ...
    FallBack "VertexLit"
    CustomEditor "StandardRoughnessShaderAUX"
}
